...
function Footer() {
  return (
    <footer className="bg-[#f3f3f3cf] py-6  px-10 font-[sans-serif]">
      <div className="md:max-w-[50%] mx-auto text-center">
        <a href="javascript:void(0)" className="inline-block">
          <img src={Logo} alt="logo" className="w-44" />
        </a>
        <p className="text-sm mt-3 text-gray-400">
          SEND ME PRINTING. <p>Sending By Messege and Delivery Order</p>
        </p>

        <ul className="mt-4">
          <li className="mt-1.5 text-sm">
            <a className="javascript:void(0)">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                className="fill-[#007bff] inline w-6 h-6"
                viewBox="0 0 24 24"
              ></svg>
            </a>
            <a href="javascript:void(0)">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                className="fill-[#007bff] inline w-6 h-6 ml-2"
                viewBox="0 0 24 24"
              ></svg>
            </a>
            <a href="javascript:void(0)">
      ...
      <ul className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-12 mt-12">
      ...
      <div className="border-t md:flex md:item-center border-gray-200 pt-6 mt-8">
        <p className="text-sm text-gray-400 ml-auto max-md:mt-4">
          Copyright © 2023
          <a href="https://readymadeui.com/" className="hover:underline mx-1">
            ReadymadeUI
          </a>
          All Rights Reserved.
        </p>
