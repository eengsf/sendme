            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="text-center lg:text-left ">
                <div className="mb-10 lg:mb-0 ">
                  <h1 className="mt-0 mb-3 ml-10 text-2xl font-bold leading-tight sm:text-lg sm:leading-tight md:text-[40px] md:leading-tight text-white ">
            ...
            <div className="w-full px-4 lg:w-1/2 ">
              <div className="text-center lg:text-right">
                <button onClick={handleClick}>
                  <a
                    className=" text-2xl font-semibold rounded-lg mx-auto inline-flex items-center justify-center bg-white py-2 px-7 hover:bg-opacity-90"
                    href="#"
                  >
                    <SiWhatsapp className="m-4" /> Order Now
                  </a>
                </button>
              </div>
            </div>
