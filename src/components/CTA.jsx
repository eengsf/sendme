...
function Cta() {
  const phoneNumber = "628970643201"; // Ganti dengan nomor WhatsApp Anda
  ...
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-indigo-600 py-16 px-8 mt-20 font-mono mb-28">
        <div className="container">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <div className="text-center lg:text-left ">
                <div className="mb-10 lg:mb-0 ">
                  <h1 className="mt-0 mb-3 ml-10 text-3xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-[40px] md:leading-tight text-white ">
                    Hasil cetakan yang berkualitas? Percayakan kepada ahlinya.
                  </h1>
            ...
            <div className="w-full px-4 lg:w-1/2 ">
              <div className="text-center lg:text-right">
                <button onClick={handleClick}>
                  <a
                    className=" text-2xl font-semibold rounded-lg mx-auto inline-flex items-center justify-center bg-white py-4 px-9 hover:bg-opacity-90"
                    href="#"
                  >
                    <SiWhatsapp className="m-4" /> Order Print
                  </a>
                </button>
              </div>
            </div>
